...
import 'package:atzos_assignment/screens/enquiry/enquiry_cubit.dart';
...
class _EnquiryFormState extends State<EnquiryForm> {
  ...
  Widget build(BuildContext context) {
      ...
      child: Column(
        ...
        children: [
          ...
          AutoSizeText(
            ...
            style:
                TextStyle(fontSize: 13.0, color: Colors.black.withOpacity(0.7)),
          ),
              ...
              SizedBox(
                ...
                child: DropdownButtonHideUnderline(
                  ...
                  items: centers.map((center) {
                    return DropdownMenuItem(
                        value: center, child: AutoSizeText(center.title));
                  }).toList(),
                      ...
                      SnackBar snackBar = SnackBar(
                        content: const Row(
                          ...
                          children: [
                            ...
                            AutoSizeText('Please fill all mandatory fields')
                          ],
                        ),
    ...
    // return Dialog(
    //     child: BlocProvider(
    //   create: (context) => EnquiryCubit()..getEnquiryFields(),
    //   child: BlocBuilder<EnquiryCubit, EnquiryState>(
    //     builder: (context, state) {
    //       debugPrint(state.centers.toString());
    //       debugPrint(state.skills.toString());
